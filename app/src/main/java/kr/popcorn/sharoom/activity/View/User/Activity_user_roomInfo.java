...
public class Activity_user_roomInfo extends FragmentActivity {

    public static Activity_user_roomInfo rActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng arg0) {
                Intent mapIntent = new Intent(Activity_user_roomInfo.this, Activity_largeMap.class);
            ...
            public void onClick(View arg0) {
                ...
                switch (arg0.getId()) {
                    case R.id.ll_facilities:
                        ...
                        customDialog = new Activity_FacillitiesInfo(Activity_user_roomInfo.this, cancelListener);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.reservationBar:
                        ...
                        Intent reservationIntent = new Intent(Activity_user_roomInfo.this, Activity_user_Reservation.class);
